...
var Typer = function (_a) {
    var sentences = _a.sentences, _b = _a.startDelay, startDelay = _b === void 0 ? 0 : _b, _c = _a.cursorDelay, cursorDelay = _c === void 0 ? startDelay : _c, _d = _a.className, className = _d === void 0 ? '' : _d, _e = _a.cursorClassName, cursorClassName = _e === void 0 ? '' : _e, _f = _a.cursorColor, cursorColor = _f === void 0 ? '' : _f, _g = _a.cursorBlinkSpeed, cursorBlinkSpeed = _g === void 0 ? 700 : _g, _h = _a.showCursor, showCursor = _h === void 0 ? true : _h, _j = _a.hideCursorOnFinish, hideCursorOnFinish = _j === void 0 ? false : _j, _k = _a.cursorSmooth, cursorSmooth = _k === void 0 ? false : _k, _l = _a.typingSpeed, typingSpeed = _l === void 0 ? 80 : _l, _m = _a.deletingSpeed, deletingSpeed = _m === void 0 ? 30 : _m, _o = _a.pauseTime, pauseTime = _o === void 0 ? 1000 : _o, _p = _a.loop, loop = _p === void 0 ? true : _p, _q = _a.style, style = _q === void 0 ? {} : _q, _r = _a.defaultText, defaultText = _r === void 0 ? '' : _r, _s = _a.onTypeFinish, onTypeFinish = _s === void 0 ? function () { } : _s;
    var _t = react.useState(defaultText), text = _t[0], setText = _t[1];
    var _u = react.useState(false), isDeleting = _u[0], setIsDeleting = _u[1];
    var _v = react.useState(0), loopNum = _v[0], setLoopNum = _v[1];
    var _w = react.useState(typingSpeed), writingSpeed = _w[0], setWritingSpeed = _w[1];
    ...
    var styledSpan = react.useMemo(function () {
        return ({
            opacity: 0,
    ...
    return (jsxRuntime.jsxs("span", __assign({ style: style }, { children: [jsxRuntime.jsx("span", __assign({ className: className }, { children: text })), !(refIsFinished.current && hideCursorOnFinish) && (jsxRuntime.jsx("span", __assign({ className: "typist-cursor ".concat("".concat(cursorClassName, " ").concat(className)), style: styledSpan }, { children: "|" })))] })));
};
