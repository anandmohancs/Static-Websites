...
var Typer = function (_a) {
    ...
    var _t = useState(defaultText), text = _t[0], setText = _t[1];
    var _u = useState(false), isDeleting = _u[0], setIsDeleting = _u[1];
    var _v = useState(0), loopNum = _v[0], setLoopNum = _v[1];
    var _w = useState(typingSpeed), writingSpeed = _w[0], setWritingSpeed = _w[1];
    ...
    return (jsxs("span", __assign({ style: style }, { children: [jsx("span", __assign({ className: className }, { children: text })), !(refIsFinished.current && hideCursorOnFinish) && (jsx("span", __assign({ className: "typist-cursor ".concat("".concat(cursorClassName, " ").concat(className)), style: styledSpan }, { children: "|" })))] })));
};
